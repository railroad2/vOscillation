...
double vPMNS::GetProbability(double L, double E, TString iflavour, TString fflavour, bool anti) const
{
...
double vPMNS::GetProbability_Smear(TString iflavour, TString fflavour) const
{
    // distance : m, energy : MeV
    int alpha;
    int beta;
...
TComplex vPMNS::GetPMNSmatrix(int row, int column) const
{
...
void vPMNS::LoadStdData(bool IO)
{
    if (IO == false)
    {
...
void vPMNS::Settheta(double theta_12, double theta_13, double theta_23)
{
    ftheta_12 = theta_12;
    ftheta_13 = theta_13;
    ftheta_23 = theta_23;
...
void vPMNS::Setradian(double rad_12, double rad_13, double rad_23)
{
    frad_12 = rad_12;
    frad_13 = rad_13;
    frad_23 = rad_23;
...
void vPMNS::Setsin(double sin_12, double sin_13, double sin_23)
{
    fsin_12 = sin_12;
    fsin_13 = sin_13;
    fsin_23 = sin_23;
...
void vPMNS::SetDm2(double Dm2_21, double Dm2_31)
{
    fDm2_21 = Dm2_21;
    fDm2_31 = Dm2_31;
